...
class RAGPerformanceTracker:
    ...
    def update_retrieval_prompt_tokens(self, prompt: str) -> None:
        """Update token count for prompts used in retrieval process"""
        tokens = self.count_tokens(prompt)
        # Accumulate as there may be multiple retrieval steps
        self.token_stats["retrieval_prompt_tokens"] += tokens
        return tokens
